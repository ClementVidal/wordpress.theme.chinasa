...
function chinasa_scripts()
{
    ...
    wp_enqueue_script('chi-angular', get_template_directory_uri().'/vendor/angular/angular.js' );
    wp_enqueue_script('chi-angular-cookies', get_template_directory_uri().'/vendor/angular-cookies/angular-cookies.js' );
    wp_enqueue_script('chi-angular-scroll', get_template_directory_uri().'/vendor/angular-scroll/angular-scroll.js' );
